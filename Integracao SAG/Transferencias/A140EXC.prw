...
@history Everson, 10/10/2022, ticket 18465 - Adicionada validação por peso em aberto.
@history Everson, 11/01/2023, ticket 18465 - Removida validação de exclusão.
@history Everson, 13/01/2023, ticket 18465 - Atualiza o status do registro na entrada de matéria-prima.
@history Everson, 16/01/2023, ticket 18465 - Atualiza o status do registro na entrada de matéria-prima.
...
RETURN(NIL)
/*/{Protheus.doc} chkZIG
	Verifica se há pesagem aberta vinculada à NF.
...
Static Function chkZIG(cNF, cSerie, cFornec, cLoja)
	...
	//Valida se o movimento é de entrada.
	If ZIF->ZIF_TPMOVI <> "E"
		RestArea(aArea)
		Return .T.
	...
	//Verifica se há pesagem iniciada.
