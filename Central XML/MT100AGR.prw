...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
@history Ticket 81308  - 07/10/2022 - Antonio Domingos - ALTERAR VENCIMENTO DE TITULOS A PAGAR NO DIA 12/10
@history ticket TI 	  - Antonio Domingos        - 13/05/2023 - Ajuste Nova Empresa
@history ticket TI - Antonio Domingos - 22/05/2023 - Revisใo Ajuste Nova Empresa
*/
User Function MT100AGR()
	...
	U_ADINF009P(SUBSTRING(ALLTRIM(PROCNAME()),3,LEN(ALLTRIM(PROCNAME()))) + '.PRW',SUBSTRING(ALLTRIM(PROCNAME()),3,LEN(ALLTRIM(PROCNAME()))),'CENTRALXML- P.E na na ap๓s a confirma็ใo da NF, apos commit ')
	...
	//Everson - 20/11/2018.
	If cEmpAnt $ _cEmpAt1 .And. Alltrim(cValToChar(SF1->F1_FORMUL)) == "S"
...
Static Function AltVencSe2()  
	...
	While ( cAliasSE2 )->( !EoF() )	
		...
		//@history Ticket 81308  - 07/10/2022 - Antonio Domingos - ALTERAR VENCIMENTO DE TITULOS A PAGAR NO DIA 12/10
		SE2->E2_VENCREA	:=  DataValida( aCtePriv[01] , .T. ) 
		MsUnlock()
