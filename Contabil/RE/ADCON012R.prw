...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
@history Ticket 85319  - Antonio Domingos - 10/01/2023 - Valida็ใo Fontes V33 - Dic. Banco de Dados.
...
User Function ADCON012R()
	...
	//+------------------------------------------------+
	 //@history Ticket 70142  - Edvar / Flek Solution - 06/04/2022 - Retirada de fun็ใo PUTSX1
	 //MontaPerg()
	 Pergunte(cPerg,.F.)
...
Static Function GeraExcel()
    ...
    */
	...
	AAdd( aCpos, "CT2_DATA")
	AAdd( aCpos, "CT2_LOTE")
	AAdd( aCpos, "CT2_SBLOTE")
	AAdd( aCpos, "CT2_DOC")
	AAdd( aCpos, "CT2_LINHA")
	AAdd( aCpos, "CT2_DEBITO")
	AAdd( aCpos, "CT2_CREDIT")
	AAdd( aCpos, "CT2_CCD")
	AAdd( aCpos, "CT2_CCC")
	AAdd( aCpos, "CT2_ITEMD")
	AAdd( aCpos, "CT2_ITEMC")
	AAdd( aCpos, "CT2_VALOR")
	AAdd( aCpos, "CT2_HIST")
	AAdd( aCpos, "CT2_FILKEY")
	AAdd( aCpos, "CT2_PREFIX")
	AAdd( aCpos, "CT2_NUMDOC")
	AAdd( aCpos, "CT2_PARCEL")
	AAdd( aCpos, "CT2_TIPODC")
	AAdd( aCpos, "CT2_CLIFOR")
	AAdd( aCpos, "CT2_LOJACF")
	AAdd( aCpos, "CT2_KEY")
	AAdd( aCpos, "D1_COD")
	AAdd( aCpos, "B1_DESC")
	AAdd( aCpos, "A2_NOME")
	AAdd( aCpos, "D1_CC")
	AAdd( aCpos, "C7_PROJETO")
	AAdd( aCpos, "CT2_LP")
	For nI := 1 To Len(aCpos)
        AADD(aCampos,{	aCpos[nI] 	,;
						GetSX3Cache(aCpos[nI], "X3_TIPO")		,;
						GetSX3Cache(aCpos[nI], "X3_TAMANHO")	,;
						GetSX3Cache(aCpos[nI], "X3_DECIMAL")	,;
						GetSX3Cache(aCpos[nI], "X3_TITULO")		,;
