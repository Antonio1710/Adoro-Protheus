...
/*/{Protheus.doc} User Function ADCON019P
    ...
    @history ticket 80822 - 28/09/2022 - Fernando Macieira - Importação CSV Estrutura PCPA200 (cadastro de componentes novos)
/*/
...
Static Function RunImpSG1()
    ...
    If lFile
        ...
        Else
            ...
            aAdd( aCampos, {'LINHA'      ,TamSX3("B1_DESC")[3]    ,250                 , 0} )
            ...
            Do While !ft_fEOF()
                ...
                If !Empty(cCOMPSubs) // @history ticket 80822 - 28/09/2022 - Fernando Macieira - Importação CSV Estrutura PCPA200 (cadastro de componentes novos) 
                    SB1->( dbSetOrder(1) ) // B1_FILIAL, B1_COD, R_E_C_N_O_, D_E_L_E_T_
