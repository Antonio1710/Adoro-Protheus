...
/*/{Protheus.doc} User Function MA455MNU
	...
	@historico chamado 18465  - Everson  - 22/03/2022 - Validação de pesagem.
...
User Function AdCorte(cAlias,nReg,nOpcx)
	...
	*/
	...
	If Alltrim(cEmpAnt) $ _cEmpAt1 .And. ! Empty(SC6->C6_XORDPES) //ticket TI - Antonio Domingos - 20/05/2023 
...
User Function ADPeso()
	...
	If _nTotalkg > 0 //Everson - 22/03/2023 - ticket 90528.
