...
/*/{Protheus.doc} User Function A410EXC
	...
	@history Everson, 23/01/2023. Ticket 18465 - Valida exclusão de pedido de venda gerado por contrato de compra de matéria-prima.
	@history Everson, 25/01/2023. Ticket 18465 - Valida exclusão de pedido de venda gerado por contrato de compra de matéria-prima.
/*/
User Function A410EXC()
	...
	If lRet .And. cFilAnt $cFiliais .And. U_ADCOM42G(SC5->C5_NUM) .And. ! IsInCallStack("U_ADCOM042P") //Everson - 25/01/2023 - Ticket 18465.
		lRet := .F.
		Help(Nil, Nil, "Função A410EXC(A410EXC)", Nil, "Pedido gerado por contrato de compra de matéria-prima não pode ser excluído", 1, 0, Nil, Nil, Nil, Nil, Nil, {""})
