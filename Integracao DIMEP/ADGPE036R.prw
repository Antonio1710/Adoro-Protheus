...
/*{Protheus.doc} User Function ADGPE036R
	...
	@since 17/07/2018
	@version 01
	@history Chamado 047019 - William Costa - 19/02/2019 - Retirado regra para descontar horario de almoço somente se tiver passagem no Refeitorio foi descontado de todos os Terceiros 
	@history Chamado 050095 - William Costa - 01/07/2019 - Adicionado regra para cálculo de terceiros que trabalham no noturno, adicionado a aba batida por batida indiferente se concluido ou não concluido
			...
			%NoPARSER%
			 SELECT TOP(1) CD_LOG_ACESSO AS CD_LOG_ACESSO_ENTRADA,
					  ...
					  WHERE NU_DATA_REQUISICAO                                            = %EXP:cData%
						...
						AND LEN(LOG_ACESSO.NU_MATRICULA)                                 >= 10 // Para trazer só os terceiros
