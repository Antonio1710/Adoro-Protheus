...
/*/{Protheus.doc} User Function AprvTran
	...
	@history Antonio Domingos , 07/10/2022, ticket 81347 - Limitar acesso a aprovação de NCC
/*/
...
/*/{Protheus.doc} FAPRUSU(_cUsuario,_cFuncao)
	(long_description)
	@type  Function
	...
	@history Antonio Domingos , 07/10/2022, ticket 81347 - Limitar acesso a aprovação de NCC
/*/
Static Function FAPRUSU(_cUsuario,_cFuncao)

Local _lRet := .T.
Local _cMV_APRUSU := SuperGetMV("MV_#APRUSU",.F.,"001958/002349/002110")

If !(__cUserID $ _cMV_APRUSU)
	_lRet :=.F.
	Aviso("APRVLOG-01", "Usuário sem permissão para "+_cFuncao+"!!!", {"&Ok"},, "Parâmetro: MV_#APRUSU")
EndIf
