...
/*/{Protheus.doc} User Function CADFVC
	...
	@history Ticket 85319  - Antonio Domingos - 10/01/2023 - Validação Fontes V33 - Dic. Banco de Dados.
	@history Ticket 85319  - Antonio Domingos - 26/01/2023 - Retirado seek para comparação onde ja está posicionado.
/*/
...
User Function COKMOTO()    
	...
	ElseIf ALTERA
		...
		AEVal( FWSX3Util():GetAllFields( "ZVC", .F. ), {|u| AADD(_aNomCpo,{ u, GetSX3Cache(u, "X3_TIPO")}) } )
		/*
		DbSelectArea("SX3")
		DbSetOrder(1)
		SX3->(DbSetOrder(1))
		...
		Enddo
		*/
		//dbSelectArea("ZVC") //Ticket 85319  - Antonio Domingos - 10/01/2023
		//DbSetOrder(1)       //Ticket 85319  - Antonio Domingos - 10/01/2023
		//If dbseek(xFilial("ZVC")+M->ZVC_CPF) //Ticket 85319  - Antonio Domingos - 10/01/2023
		...
		//Endif //Ticket 85319  - Antonio Domingos - 10/01/2023
