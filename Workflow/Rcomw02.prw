...
//@history ticket 85390 - Antonio       - 10/02/2023 - Valid fontes v33-dic.bco       
//@history ticket T.I   - WILLIAM COSTA - 17/05/2023 - INCLUSAO DA EMPRESA 13
//@history ticket TI - Antonio Domingos - 26/05/2023 - Revisใo Ajuste Nova Empresa
...
// *** INICIO TICKET T.I  - 17/05/2023 - WILLIAM COSTA - INCLUSAO DA EMPRESA 13
...
USER FUNCTION WF15()
U_sc({'13',5})    // PC REPROVADOS

USER FUNCTION WF16()     //1
U_PedCom( {'13',1} )		// Processo de Envio de PC para aprova็ใo

USER FUNCTION WF17()
U_PedCom( {'13',2} )		// Processo de Retorno do Workflow

USER FUNCTION WF18()    //1
U_PedCom( {'13',3} )		// Processo de Resposta de Pedido Bloqueado para Comprador

USER FUNCTION WF19()
U_PedCom( {'13',4} )		// Processo de Retorno de Pedido Reprovado

USER FUNCTION WF20()     //1
U_PedCom( {'13',5} )		// Processo de Resposta de Pedido Aprovado para Comprador

USER FUNCTION WF21()
U_PedCom( {'13',6} )		// Time-out

USER FUNCTION WF22()		// Processo de Envio de E-Mail
U_xSENDMAIL( {'13'} )

USER FUNCTION WF23()//1
U_PedCom( {'13',7} )		// Processo de Envio de PC para Aprovacao NIvel 2

USER FUNCTION WF24() //1
U_PedCom( { '13',8 } )		// Processo de Envio de PC Liberado Manualmente no Sistema

// *** FINAL TICKET T.I  - 17/05/2023 - WILLIAM COSTA - INCLUSAO DA EMPRESA 13
...
U_ADINF009P('RCOMW02' + '.PRW',SUBSTRING(ALLTRIM(PROCNAME()),3,LEN(ALLTRIM(PROCNAME()))),'ENVIA EMAILS ATRAVES DE UM SMTP SERVER CONFIGURADO')
...
aStruct2 := {} //ticket 85390 - Antonio - 10/02/2023

AADD( aStruct2, {'ORIGEM'    ,'C',70,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct2, {'DESTINO'   ,'C',70,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct2, {'USUARIO'   ,'C',15,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct2, {'COMPUTADOR','C',35,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct2, {'HORA'      ,'C',08,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct2, {'QUANDO'    ,'D',08,0} ) //ticket 85390 - Antonio - 10/02/2023

oTTEMP := FWTemporaryTable():New("TTEMP", aStruct2) //ticket 85390 - Antonio - 10/02/2023
oTTEMP:Create()	

// xApaga := U_CriaTMP( aStruct2, "WORK" )
/*
If !File('\Dadosadv\Dadosadv.dbf')
	MSCreate('\Dadosadv\Dadosadv.dbf',aStruct2,"CTREECDX")
	//DbCreate('\Tabelas\Dadosadv.dbf', aStruct2)
...
aStruct := {} //ticket 85390 - Antonio - 10/02/2023

AADD( aStruct, {'TROK'   ,'C',02,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct, {'ARQUIVO','C',50,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct, {'TAMANHO','N',10,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct, {'_DATA'  ,'D',08,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct, {'HORA'   ,'C',08,0} ) //ticket 85390 - Antonio - 10/02/2023
AADD( aStruct, {'ATRIBUT','C',01,0} ) //ticket 85390 - Antonio - 10/02/2023
...
oTrb := FWTemporaryTable():New("TRB", _aCampos)
oTrb:Create()	

//xApaga := U_CriaTMP( aStruct, "TRB" )
...
//@history Ticket 70142  - Edvar / Flek Solution - 07/04/2022 - Retirada de fun็ใo PUTSX1
...
//xApaga := U_CriaTMP( aStruct, "TRB" )
oTrbx := FWTemporaryTable():New("TRB", aStruct)
oTrbx:Create()	
...
WaitRunSrv("D:\CSU_R3\Protheus_Data\SYSTEMhom\wfbat.bat",.t.,"D:\CSU_R3\Protheus_Data\SYSTEMhom\")
