...
Static Function oOKREFT()
	...
	//ticket TI - Antonio Domingos - 18/05/2023 - Incluido Empresa 13 
	Local cEmpRN:= GetMv("MV_#RNEMP",,"01|02|13") //Ticket 69574   - Abel Bab - 21/03/2022 - Projeto FAI
	...
	if lCont
		...
		lRet := .T.
		if Alltrim(cEmpAnt) $ cEmpRN //ticket TI - Antonio Domingos - 18/05/2023 - Ajuste Nova Empresa
