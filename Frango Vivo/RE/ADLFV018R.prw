...
/*/{Protheus.doc} User Function ADLFV018R()
  ...
  @history Ticket 89245 - Adriano Savoine      - 28/02/2023 - Retirado o tamsx3 e colocado valor fixo para carregar os dados.
/*/
...
Static Function ReportDef(oReport)
	...
	TRCell():New(oSection2,"GTA"   	            	,cAlias,"GTA"        	,"@!"               	,010,  ,,"LEFT",,"LEFT",,,,,,,) //03 //Ticket 76225 - Everson              - 11/07/2022 - Tratamento para colunas que não estavam saindo no relatório.
	TRCell():New(oSection2,"GRNJ"   	            ,cAlias,"GRNJ"        	,"@!"               	,008,  ,,"LEFT",,"LEFT",,,,,,,) //02
	TRCell():New(oSection2,"MUNICIPIO"            	,cAlias,"MUNICÍPIO"    	,"@!"               	,020,  ,,"LEFT",,"LEFT",,,,,,,) //04 //Ticket 76225 - Everson              - 11/07/2022 - Tratamento para colunas que não estavam saindo no relatório.
