...
User Function TABPEDAG() 
	...
	//oTrb:AddIndex("IDX001", {"RB_CODIGO"} ) //Ticket 85319  - Antonio Domingos - 26/01/2023
	oTrb:AddIndex("IDX001", {"RB_CODIGO","RB_CODROD"} ) //Ticket 85319  - Antonio Domingos - 26/01/2023
	oTrb:Create()
	...
	//Ticket 85319  - Antonio Domingos - 26/01/2023
	...
	DBSELECTAREA("TRB")
 	DBCLOSEAREA()
  	//FERASE(cArq)   //Ticket 85319  - Antonio Domingos - 26/01/2023
