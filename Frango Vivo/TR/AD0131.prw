...
/*/{Protheus.doc} User Function nomeFunction
	...
	@history Ticket 79442 - Adriano Savoine - 07/09/2022 - Nao permitir alterar a ordem fechada.
/*/
User Function AD0131()  
	...
	PRIVATE cFecha   := ZV1->ZV1_FECHA 	//Adriano Savoine 07/09/2022
	...
	If !Empty(cFecha)
		MsgAlert ("Atenção, Ordem ja fechada. Alteração nao permitida! " + cvaltochar(cNumOC)) //Tichet: 79442 - 07/09/2022 - ADRIANO SAVOINE
		RestArea(_aArea)
		Return  .F.
	EndIf
	...
	If _cConfirm = 'S'	
		...
		If val(_nGuia) = 0		
			...
			If dbSeek("  "+_cContrSeq)
				...
				MsUnlock()
			Endif*/
			_nGuia := Soma1( GetMV(_cContrSeq) )
			PutMV(_cContrSeq, _nGuia  )
		Else
