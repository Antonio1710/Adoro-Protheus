...
/*/
	...
	@history Ticket 79442   - Adriano Savoine      - 07/09/2022 - Não permite alterar ordens fechadas.
	@history TICKET 86586   - ADRIANO SAVOINE      - 09/02/2023 - Criado um novo campo na tela para alterar o numero do Galpão da apanha de aves.
/*/
...
User Function XAltZV1()
	...
	If cFlgInt = 'I'
		...
		Return  .F.
	ElseIf !Empty(cfecha)
		MsgAlert ("Atenção, Ordem ja Fechada. Alteração nao permitida! " + cvaltochar(cNumOC)) //Ticket: 79442 - Adriano Savoine - 07/09/2022
		Return  .F.
	Else
