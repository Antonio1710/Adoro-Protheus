...
Static Function ChkCodMem(cNextCod, cSX2)
    ...
    EndIf
    */
    //@history Ticket 70142  - Rodrigo / Flek Solution - 22/02/2023 - Ajustes Dic. de dados no Banco
    FwPutSX5('', cTabX5, AllTrim(FWxFilial(cSX2)) + AllTrim(cSX2), cNextCod, cNextCod, cNextCod, cNextCod)
