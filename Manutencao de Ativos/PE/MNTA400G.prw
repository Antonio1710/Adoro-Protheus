...
/*/{Protheus.doc} User Function MNTA400G()
  Checagem de validação antes da exclusão da O.S na tela do retorno da OS
  @type  Function
  @author Tiago Stocco
  @since 18/10/202
...
User Function MNTA400G()
    ...
    If Alltrim(RetCodUsr()) $ usrCancOS
        ...
        ENDIF
    Else
        MSGALERT("Você não tem permissão de Cancelar OS", "PE:MNTA400G - MV_#USRCOS" )
        Return .F.
    EndIf

	/******* Deixar o log sempre por último *******/
	//Everson - 13/02/2023 - ticket 88099.
	U_ADMNT220("", cOS, "EXCLUSÃO OS", "")
	//
