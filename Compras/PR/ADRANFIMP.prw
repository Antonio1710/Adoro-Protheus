...
User Function CadNF(_nOpca)
	...
	AAdd(aCpos, "ZZB_COD")
	AAdd(aCpos, "ZZB_QUANT")
	AAdd(aCpos, "ZZB_VUNIT")
	AAdd(aCpos, "ZZB_TOTAL")                                                                                                
	AAdd(aCpos, "ZZB_TES")
	AAdd(aCpos, "ZZB_CF")
	AAdd(aCpos, "ZZB_FRETE")
	AAdd(aCpos, "ZZB_SEGURO")
	AAdd(aCpos, "ZZB_DESPES")
	AAdd(aCpos, "ZZB_BASEII")
	AAdd(aCpos, "ZZB_PII")
	AAdd(aCpos, "ZZB_II")
	AAdd(aCpos, "ZZB_BASEIP")
	AAdd(aCpos, "ZZB_IPI")
	AAdd(aCpos, "ZZB_VALIPI")
	AAdd(aCpos, "ZZB_BSIMP5")
	AAdd(aCpos, "ZZB_ALIMP5")
	AAdd(aCpos, "ZZB_VLIMP5")
	AAdd(aCpos, "ZZB_BSIMP6")
	AAdd(aCpos, "ZZB_ALIMP6")
	AAdd(aCpos, "ZZB_VLIMP6")
	AAdd(aCpos, "ZZB_BASEIC")
	AAdd(aCpos, "ZZB_PICM")
	AAdd(aCpos, "ZZB_VALICM")
	AAdd(aCpos, "ZZB_CONTA")
	AAdd(aCpos, "ZZB_ITEMCT")
	AAdd(aCpos, "ZZB_CC")
	AAdd(aCpos, "ZZB_CVLV")
	AAdd(aCpos, "ZZB_ADICAO")
	AAdd(aCpos, "ZZB_SEQADI")
	AAdd(aCpos, "ZZB_DESCADI")
	AAdd(aCpos, "ZZB_C7NUM")
	AAdd(aCpos, "ZZB_ITEMPC")

	For nI := 1 To Len(aCpos)
		AADD(AHEADER,{	GetSX3Cache(aCpos[nI], "X3_TITULO")	,;
...
User Function GeraNF()
	...
	Private cNumero:= ""
	Private cSerie := "NF2"
	Private _cEmpFL9 := SuperGetMv("MV_#EMPFL9",.F.,"0102/0103/0106/1301") //Codigos de Empresas+Filiais Ativas Grupo 9 //ticket TI - Antonio Domingos - 19/05/2023	
	...
	//			aAdd(aItem1[Len(aItem1)],{"D1_CVLV"			,ZZB->ZZB_CVLV						,NIL})
		    ...
		    If Len(aItem1) > 0
				...
				if alltrim(cEmpAnt)+alltrim(cfilant) $ _cEmpFL9 //ticket TI - Antonio Domingos - 19/05/2023 
				   _cEspNf := "SPED"
				else
				   _cEspNf := "NF"
				endif
...
Static Function Visual()
	...
	oTrb := FWTemporaryTable():New("TRB", aDbStru)
	oTrb:AddIndex("IDX001", {"TR_FOR","TR_LJ","TR_NCM"} )
	oTrb:Create()
