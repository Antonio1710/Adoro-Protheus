...
User Function MTA265MNU()
    ...
    aAdd(aRotina,{ "* Endereça A2_XTIPO=4 (Beneficiamento)", "u_RunChkSDA('BENEF')", 0 , 2, 0, .F.})
    aAdd(aRotina,{ "* Endereça Produtos Almoxarifado", "u_RunSBE('ALMOX')", 0 , 2, 0, .F.}) // @history Ticket 77543 - Fernando Macieira - 03/08/2022 - SD1 sem endereçamento automático apartir de 25/07/2022
    aAdd(aRotina,{ "* Endereça RATEIO", "u_RunChkSDA('RATEIO')", 0 , 2, 0, .F.}) // @history Ticket 78387 - Fernando Macieira - 17/08/2022 - Endereçamento itens rotina de Gera ajuste (DOC RATEIO - TABELA SD3)
...
User Function RunChkSDA(cTipo)
    ...
    FWMsgRun(, {|| u_ChkSDA(cTipo) }, "Aguarde", "Efetuando endereçamentos pendentes ["+Time()+"] ...")
...
/*/{Protheus.doc} User Function RunSBE
    ...
    @history Ticket 77543 - Fernando Macieira - 03/08/2022 - SD1 sem endereçamento automático apartir de 25/07/2022
/*/
User Function RunSBE(cTipo)

    Default cTipo := "" // @history Ticket 78387 - Fernando Macieira - 17/08/2022 - Endereçamento itens rotina de Gera ajuste (DOC RATEIO - TABELA SD3)

    FWMsgRun(, {|| RunSBESDA(cTipo) }, "Aguarde", "Efetuando endereçamentos pendentes ["+Time()+"] ...")
...
/*/{Protheus.doc} nomeStaticFunction
    ...
    @history Ticket 77543 - Fernando Macieira - 03/08/2022 - SD1 sem endereçamento automático apartir de 25/07/2022
/*/
Static Function RunSBESDA(cTipo)
