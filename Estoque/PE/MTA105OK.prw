...
USER FUNCTION MTA105OK()
	...
	Local nContLg	   := 0
	Private _cEmpAt3 := SuperGetMv("MV_#EMPAT3",.F.,"01/09/13") //Codigo de Empresas Ativas Grupo 3 //ticket TI - Antonio Domingos - 20/05/2023
	...
	FOR nCont:=1 TO LEN(acols)
		...
		//Everson - 16/02/2023 - ticket 88099.
		If lRet .And. nPosOP > 0 .And. nContLg == 0
		
			If ! Empty(aCols[nCont][nPosOP])
		
				U_ADMNT220(aCols[nCont][nPosOP], "", Iif(INCLUI, "INCLUSÃO ", "ALTERAÇÃO ") + "DE SOLICITAÇÃO AO ARMAZEM " + CA105NUM, "")
				nContLg++
