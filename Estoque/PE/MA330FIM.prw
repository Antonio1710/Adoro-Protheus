...
/*/{Protheus.doc} User Function nomeFunction
	...
	@history ticket 77258 - 22/11/2022 - Fernando Macieira - Rotina Virada de Saldos - Descontinuada em 31/12/2022
/*/
User Function MA330FIM()
	...
	// @history ticket 77258 - 22/11/2022 - Fernando Macieira - Rotina Virada de Saldos - Descontinuada em 31/12/2022
	If a330ParamZX <> NIL
		If Len(a330ParamZX) > 0
			dDataBase := a330ParamZX[1] 
		EndIf
	EndIf
	//
	...
	//cQuery += " AND D3_EMISSAO LIKE '"+Left(DtoS(MV_PAR01),6)+"%' " // @history ticket 77258 - 14/11/2022 - Fernando Macieira - Rotina Virada de Saldos - Descontinuada em 31/12/2022
	cQuery += " AND D3_EMISSAO LIKE '"+Left(DtoS(dDataBase),6)+"%' "
