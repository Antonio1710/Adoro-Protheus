...
User Function A103CUST()
	...
	Local _cEmpAt1 := SuperGetMv("MV_#EMPAT1",.F.,"01/13") //Codigo de Empresas Ativas Grupo 1 //ticket TI - Antonio Domingos - 20/05/2023
	...
	//IF CEMPANT              == '01'               .AND. ;
	IF cEmpAnt $ _cEmpAt1 .AND. ; //ticket TI - Antonio Domingos - 20/05/2023 
