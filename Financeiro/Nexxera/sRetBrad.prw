...
±±ºDesc.     ³Retorna os dados para os CNABs do Bradesco                  º±±		
±±ÈÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/

User Function sRetBrad( cTipo )    	 					   			 		     			
...
elseif	cTipo == "TRIB"	
	...
	if	Upper(Alltrim(SEA->EA_MODELO)) == "16"			
		...
		cRet	+=	StrZero(SE2->E2_ZZVLPR * 100,14)																// 160 a 174 - Valor do principal        					
		cRet	+=	StrZero(SE2->E2_ZZVLMT * 100,14)																// 175 a 189 - Valor da multa            					
		cRet	+=	StrZero(SE2->E2_ZZVLJR * 100,14)																// 190 a 204 - Valor do juros / encargos 					
