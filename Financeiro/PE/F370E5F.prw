...
/*/{Protheus.doc} User Function F370E5F
    ...
    @hisotry ticket 79041- Everson/Antonio - 29/08/2022 - Altera consulta pois estava estourando o tamanho da string do script sql, no ini do appserver já está no limite 65536.
/*/
