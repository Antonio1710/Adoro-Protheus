...
Static Function FileTRC()
    ...
    oTrc := FWTemporaryTable():New(cAliasTmp, aStrut)
	oTrc:AddIndex("01", {"TMP_CPSZF"} ) //Ticket 85319  - Antonio Domingos - 21/02/2023
	oTrc:AddIndex("02", {"TMP_DESSZF"} )//Ticket 85319  - Antonio Domingos - 21/02/2023
	oTrc:AddIndex("03", {"TMP_QTDINA"} )//Ticket 85319  - Antonio Domingos - 21/02/2023
	oTrc:AddIndex("04", {"TMP_QTDATI"} )//Ticket 85319  - Antonio Domingos - 21/02/2023
	oTrc:AddIndex("05", {"TMP_QTDDIF"} )//Ticket 85319  - Antonio Domingos - 21/02/2023
	oTrc:Create()
