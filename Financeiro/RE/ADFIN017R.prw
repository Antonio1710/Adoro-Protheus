...
/*/{Protheus.doc} User Function ADFIN017R
	Relatório de apoio para compensação entre carteiras
	@type  Function
	...
	@history ticket 18495 - Fernando Macieira - 18/08/2021 - PARAMENTROS COMPESAÇÃO DE CONTAS
/*/
...
Static Function SqlGeral()
	...
	SELECT A1_COD,
		...
		WHERE (%Table:SA1%.D_E_L_E_T_  <> '*'
		   ...
		   AND E1_SALDO           > 0
		   AND E1_TIPO             IN %Exp:cEmbTipos% // @history ticket 18495 - Fernando Macieira - 18/08/2021 - PARAMENTROS COMPESAÇÃO DE CONTAS
		   ...
		   AND E2_LOJA             = A2_LOJA
		   AND E2_SALDO            > 0
		   AND E2_TIPO             IN %Exp:cEmbTipos% // @history ticket 18495 - Fernando Macieira - 18/08/2021 - PARAMENTROS COMPESAÇÃO DE CONTAS
...
Static function FBSCSLD(_cCOD,_nTp)
	...
	IF _nTp == 1
		...
		_cQuery += " WHERE E1_CLIENTE = '"+_cCod+"' AND E1_TIPO IN "+FormatIn(cTipos,"|")+" " // @history ticket 18495 - Fernando Macieira - 18/08/2021 - PARAMENTROS COMPESAÇÃO DE CONTAS
	...
	Else
		...
		_cQuery += "WHERE E2_FORNECE = '"+_cCod+"' AND E2_TIPO IN "+FormatIn(cTipos,"|")+" " // @history ticket 18495 - Fernando Macieira - 18/08/2021 - PARAMENTROS COMPESAÇÃO DE CONTAS
