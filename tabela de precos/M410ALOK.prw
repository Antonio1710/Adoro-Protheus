...
User Function M410ALOK()
	...
	Local _cEmpFL5 := SuperGetMv("MV_#EMPFL5",.F.,"0102/010B/1301") //Codigo de Empresas+Filiais Ativas Grupo 4 // ticket TI - Antonio Domingos    - 13/05/2023
	//Local cEmpSF:= GetMv("MV_#SFEMP",,"01|") 		//Ticket 69574   - Abel Babini          - 21/03/2022 - Projeto FAI
	Local _cFilRotOK	:= GetMV("MV_#FILROT",,"03")
	Private _cEmpAt3 := SuperGetMv("MV_#EMPAT3",.F.,"01/09/13") //Codigo de Empresas Ativas Grupo 3 // ticket TI - Antonio Domingos    - 13/05/2023
	...
	if !_lCopia //&&conforme email Vagner 15/06/11 permitir copia. Ana informou que perfil do usuario define se este pode copiar ou nao.
		...
		If cEmpAnt $ _cEmpAt3 //; // ticket TI - Antonio Domingos    - 13/05/2023
	...
	*/
	//If !(cEmpAnt $ _cEmpRotOK) // @history ticket 8786 - 05/02/2021 - Fernando Macieira - Alterar ou Excluir Pedido de Venda - Base de Dados Adoro
		//If !(cFilAnt $ _cFilRotOK) .or. !Empty(SC5->C5_NOTA)
	If !(cEmpAnt $ _cEmpRotOK) // @history ticket 8786 - 05/02/2021 - Fernando Macieira - Alterar ou Excluir Pedido de Venda - Base de Dados Adoro
		If !(cFilAnt $ _cFilRotOK) .or. !Empty(SC5->C5_NOTA)
	...
	If Alltrim(cEmpAnt)+Alltrim(cFilAnt) $ _cEmpFL5 //ticket TI - Antonio Domingos - 13/05/2023
