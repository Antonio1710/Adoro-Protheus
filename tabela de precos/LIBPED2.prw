...
Static Function AtuListBox( _aRede, _aPedidos,_aItens,_nOpc)
	...
	If _nOpc == 1 .Or. _nOpc == 3
		BeginSql Alias _cAlias
			...
			AND SC5.C5_XGERSF <> %Exp:'3'% //Everson - 17/05/2023. Tratamento SalesForce. Chamado 91301.
...
Static Function fSelSupervisor(_cGerente,_aPedidos,_cTipo,_aItens,_nOpc)
	...
	_cQuery += " SC5.C5_XGERSF <> '2' AND SC5.C5_XGERSF <> '3' AND " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
...
Static Function fSelItens( _cPed,_aItens)
	...
	_cQuery += " AND SC5.C5_XGERSF <> '2' AND SC5.C5_XGERSF <> '3'  " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
	...
	For _n1 := 1 to Len(_aRede)
		...
		*/
		If _aRede[_n1][01]
			...
			_cQueryR += "      AND C5_XGERSF <> '2' AND C5_XGERSF <> '3'  " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
