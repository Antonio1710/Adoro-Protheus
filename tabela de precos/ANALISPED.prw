...
Static Function AnPedRd()
	...
	*/ 
	...
	cQuery += "      C5_XGERSF <> '2' AND C5_XGERSF <> '3' AND " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
	...
	While !Eof() // Inicio do calculo do IPTAB por rede.
		...
		If _nValIp < 1 .And. _lZero == .F. .And. _lVen == .T.  	
			...
			*/
			...
			_cQuery4 += "      C5_XGERSF <> '2' AND C5_XGERSF <> '3' AND " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
		...
		Else // Libera a rede
			...
			_cQuery6 += "      C5_XGERSF <> '2' AND C5_XGERSF <> '3' AND " // Everson - 19/07/2018. Chamado 037261. //Everson - 17/05/2023 - ticket 91301.
